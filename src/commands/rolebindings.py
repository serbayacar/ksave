...
class RoleBinding:
    ...
    def __init__(self,sub_parser):
        # create the parser for the "rolebindings" sub-command
        parser_rolebinding = sub_parser.add_parser('rolebindings', help='Back up your Kubernetes RoleBinding objects')
